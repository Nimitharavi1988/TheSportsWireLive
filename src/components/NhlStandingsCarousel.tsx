...
// Same header-bar-with-arrows pattern as NflStandingsCarousel.tsx, but with
// a Points column (and OTL) instead of a plain W/L table — hockey standings
// are conventionally ranked/read by points, not raw win-loss, since an
// OT/shootout loss still earns a point.
            ...
            <Table size="small" sx={{ "& th, & td": { fontSize: 12, px: 1, py: 0.75 } }}>
              <TableHead>
                <TableRow sx={{ bgcolor: "action.hover" }}>
                  ...
                  <TableCell align="right" sx={{ fontWeight: 700 }}>OTL</TableCell>
