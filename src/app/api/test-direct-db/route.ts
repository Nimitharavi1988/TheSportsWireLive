/**
 * ONE-OFF diagnostic route (2026-09-18, re-added for a clean retest after
 * the Accelerate credential-rotation incident settled) — verifies whether
 * Prisma's Neon driver adapter (@prisma/adapter-neon, WebSocket-based Pool,
 * no query engine binary/WASM at all) works on Cloudflare Workers, as
 * opposed to Prisma's own native engines (confirmed blocked there — see
 * db.ts's header comment).
 *
